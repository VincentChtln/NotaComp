...
'
    ...
    For Index = 1 To Sheets.Count Step 1
        If Worksheets(Index).Name Like "Elève*" Then
            ...
            For Indice_eleve = 1 To Nb_Ele Step 1
                ...
                Range(Cells(5, Colonne + 1), Cells(21, Colonne + 1)).Copy
                Range(Cells(5, Colonne), Cells(21, Colonne)).PasteSpecial Paste:=xlPasteValues
...
'
    ...
    For Indice_eleve = Eleve_depart To Nb_El
        ...
        Else
            ...
            Range(Cells(1, New_col), Cells(Nb_Lig, New_col + Decal - 1)).PasteSpecial Paste:=xlPasteFormats
        End If
    Next Indice_eleve
...
Sub Test()
' test de la fonction ajout d'éval
    numt = 2
    Ajout_Evaluation (numt)
End Sub
